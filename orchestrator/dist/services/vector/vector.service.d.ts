...
import { DocumentChunk, VectorSearchResult } from 'src/interfaces/types';
export declare class VectorService implements OnModuleInit {
    ...
    searchSimilar(queryEmbedding: number[], limit?: number, scoreThreshold?: number): Promise<VectorSearchResult[]>;
